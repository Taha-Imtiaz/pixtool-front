            ...
            <div className="heroSec__billBoard">
                <div className="billBoard">
                    <div className="billBoard__left">
                        <p className="billBoard__text">
                            Best Video 3D
                            <span className="billBoard__text--primary">&nbsp;Editing&nbsp;</span> 
                            Tool
                        </p>
